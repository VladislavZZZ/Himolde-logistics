        ...
        <div class="mx-auto">
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="row mt-3">
                <h6 class="fw-bold col px-md-4"> Write all supplies</h6>
              </div>
              <div class="row" >
                <input 
                    type="text"
              ...
              <div class="row mt-3">
                <h6 class="fw-bold col px-md-4"> Write all demands</h6>
              </div>
              <div class="row" >
                <input 
                    type="text"
              ...
              <div class="row mt-3">
                <h6 class="fw-bold col px-md-4"> Write the costs</h6>
              </div>
              <div class="row">
                <textarea
  ...
  export default {
    ...
    methods: {
      ...
      async proccessRequests() {
        this.loadingSt = true;
        var demands = this.dcount;
        var supp = this.scount;
        var weights = this.inputcontent;
        const path = 'http://127.0.0.1:5000/Transp';
