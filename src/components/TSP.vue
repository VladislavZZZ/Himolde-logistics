  ...
  <div class="bodyContent">
    <div class="text-center mt-4">
      <div class="text-center page-header">
        ...
        <h4><small>Given a set of cities and distances between every pair of cities, the problem is to find the shortest possible route that visits every city exactly once and returns to the starting point.
           <br> The Hamiltonian cycle problem is to find if there exists a tour that visits every city exactly once.<br> <strong>Traveling Salesman Problem</strong> is about to find a minimum weight Hamiltonian Cycle.</small></h4>
    </div>
        ...
        <div class="mx-auto">
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="row">
                <h6 class="fw-bold col px-md-4"> start point</h6>
              </div>
              <div class="row">
                <input
                    type="text"
  ...
  export default {
    ...
    methods: {
      ...
      async proccessRequests() {
        this.loadingSt = true;
        var start = parseInt(this.startInp);
        var vnumber = parseInt(this.vcount)
        var weights = this.inputcontent;
        const path = 'http://127.0.0.1:5000/TSP';
        var payload = {
          "v":vnumber,
          "weights":weights,
          "start":start
        ...
        // for (var val of this.setupActions) {
          // await fetch(
          //   `${this.$config.BASE_SERVICE_URL}:${this.ports[val]}/api/text-refine/${val}`,
          //   {
          //     method: 'POST',
          //     body: this.$store.getters.textContent,
          //   },
          // )
          //   .then((response) => {
          ...
          //       ElMessage({
          //         type: 'success',
          //         message: 'Предобработка ' + val + ' выполена успешно',
          //       });
          //       console.log(val + ' got correct');
          ...
          //           response.status,
          //       });
          //       console.log(val + ' failed with status ' + response.status);
          //       return this.$store.getters.textContent;
          //     }
          //   })
          //   .then((data) => {
          //     this.$store.dispatch('setTextContentAndLatestResult', data);
          //     this.content = data;
          //   })
          //   .catch((error) => {
          //     ElMessage({
          //       type: 'error',
          //       message: 'Предобработка ' + val + ' не выполнена',
          //     });
          //     this.loadingSt = false;
          //     console.log(error);
          //   });
